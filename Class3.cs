...
public static class Drawing
{
    ...
    // Token: 0x06000139 RID: 313 RVA: 0x00011514 File Offset: 0x0000F714
    public static void DrawBezierLine1(Vector2 start, Vector2 startTangent, Vector2 end, Vector2 endTangent, Color color, float width, bool antiAlias, int segments)
    {
