...
public class draw
{
    ...
    public static void DrawLineStretched12(Vector2 lineStart, Vector2 lineEnd, Texture2D texture, float thickness)
    {
    ...
    public static void DrawLine(Vector2 startPos, Vector2 endPos, float thickness)
    {
        ...
        DrawLineStretched12(startPos, endPos, draw.texture, thickness);
    }
    ...
    public static void DrawLineStretched(Vector2 lineStart, Vector2 lineEnd, Texture2D texture, float thickness)
    {
        ...
        int num2 = (int)Mathf.Ceil(thickness / 2f);
        GUIUtility.RotateAroundPivot(num, lineStart);
        GUI.DrawTexture(new Rect(lineStart.x, lineStart.y - num2, vector.magnitude, thickness), texture);
    ...
    public static void CornerBox(Vector2 Head, float Width, float Height, float thickness, Color color, bool outline)
    {
        ...
        if (outline)
        {
            draw.RectFilled(Head.x - Width / 2f - 1f, Head.y - 1f, num + 2, 3f, Color.black);
            draw.RectFilled(Head.x - Width / 2f - 1f, Head.y - 1f, 3f, num2 + 2, Color.black);
            draw.RectFilled(Head.x + Width / 2f - num - 1f, Head.y - 1f, num + 2, 3f, Color.black);
            draw.RectFilled(Head.x + Width / 2f - 1f, Head.y - 1f, 3f, num2 + 2, Color.black);
            draw.RectFilled(Head.x - Width / 2f - 1f, Head.y + Height - 4f, num + 2, 3f, Color.black);
            draw.RectFilled(Head.x - Width / 2f - 1f, Head.y + Height - num2 - 4f, 3f, num2 + 2, Color.black);
            draw.RectFilled(Head.x + Width / 2f - num - 1f, Head.y + Height - 4f, num + 2, 3f, Color.black);
            draw.RectFilled(Head.x + Width / 2f - 1f, Head.y + Height - num2 - 4f, 3f, num2 + 3, Color.black);
        }
        draw.RectFilled(Head.x - Width / 2f, Head.y, num, 1f, color);
        draw.RectFilled(Head.x - Width / 2f, Head.y, 1f, num2, color);
        draw.RectFilled(Head.x + Width / 2f - num, Head.y, num, 1f, color);
        draw.RectFilled(Head.x + Width / 2f, Head.y, 1f, num2, color);
        draw.RectFilled(Head.x - Width / 2f, Head.y + Height - 3f, num, 1f, color);
        draw.RectFilled(Head.x - Width / 2f, Head.y + Height - num2 - 3f, 1f, num2, color);
        draw.RectFilled(Head.x + Width / 2f - num, Head.y + Height - 3f, num, 1f, color);
        draw.RectFilled(Head.x + Width / 2f, Head.y + Height - num2 - 3f, 1f, num2 + 1, color);
    }
    ...
    public static void PlayerCornerBox1(Vector2 Head, float Width, float Height, float thickness, int distance, Color color)
    {
        int num = (int)(Width / 4f);
        int num2 = num;
        draw.RectFilled(Head.x - Width / 2f - 1f, Head.y - 1f, num + 2, 3f, color);
        draw.RectFilled(Head.x - Width / 2f - 1f, Head.y - 1f, 3f, num2 + 2, color);
        draw.RectFilled(Head.x + Width / 2f - num - 1f, Head.y - 1f, num + 2, 3f, color);
        draw.RectFilled(Head.x + Width / 2f - 1f, Head.y - 1f, 3f, num2 + 2, color);
        draw.RectFilled(Head.x - Width / 2f - 1f, Head.y + Height - 4f, num + 2, 3f, color);
        draw.RectFilled(Head.x - Width / 2f - 1f, Head.y + Height - num2 - 4f, 3f, num2 + 2, color);
        draw.RectFilled(Head.x + Width / 2f - num - 1f, Head.y + Height - 4f, num + 2, 3f, color);
        draw.RectFilled(Head.x + Width / 2f - 1f, Head.y + Height - num2 - 4f, 3f, num2 + 3, color);
        draw.RectFilled(Head.x - Width / 2f, Head.y, num, 1f, color);
        draw.RectFilled(Head.x - Width / 2f, Head.y, 1f, num2, color);
        draw.RectFilled(Head.x + Width / 2f - num, Head.y, num, 1f, color);
        draw.RectFilled(Head.x + Width / 2f, Head.y, 1f, num2, color);
